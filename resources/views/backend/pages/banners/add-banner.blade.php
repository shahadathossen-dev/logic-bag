...
@php 
    $data['breadcrumb'] =   [
            ...
            'Add Banner' => route('admin.banner.add'),
        ];
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.banner.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="subcategory_thumb" type="file" class="form-control{{ $errors->has('banner') ? ' is-invalid' : '' }}" name="banner" value="{{ old('banner') }}" required autofocus>
                                    ...
                                    <div class="col-md-2">
                                        <img class="" id="selectedImage" width="100" height="120" src="#" alt="Banner image"/>
                                    </div>
                                </div>
