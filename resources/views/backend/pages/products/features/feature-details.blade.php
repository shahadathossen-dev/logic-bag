...
@php 
    $data = ['Home', 'Features', 'Edit Feature'];
@endphp
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin.features.update') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') ? old('name') : $feature->name }}" required autofocus>
