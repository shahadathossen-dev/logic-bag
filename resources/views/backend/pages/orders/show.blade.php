                    ...
                    <div class="card-body">
                        <table id="product" class="table table-bordered table-striped mb-3">
                            ...
                            <tbody>
                                ...
                                @if ($product->hasDiscount())
                                <tr><th class="text-right">{{ 'Discount' }}</th><td>{{($product->discount->amount*100)}}%</td></tr>
                                @endif
                                ...
                                <form id="form_form" method="POST" action="{{ route('admin.product.discount.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <input id="amount" type="number" step="0.01" min="0" class="form-control{{ $errors->has('amount') ? ' is-invalid' : '' }}" name="amount" value="{{ old('amount') }}" required autofocus>
