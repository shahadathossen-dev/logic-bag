                    ...
                    <form id="product_form" method="POST" action="{{ route('admin.product.store') }}" enctype="multipart/form-data">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <textarea id="description" class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="editor" placeholder="Place some text here" style="height: 300px; font-size: 14px; line-height: 18px;" >{{ old('description') }}</textarea>
