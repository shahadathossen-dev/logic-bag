...
@php 
    $data['breadcrumb'] =   [
            ...
            'Edit Category' => route('admin.category.edit', ['id', $category->id]),
        ];
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.category.update') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input id="title" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ old('title') ? old('title') : $category->title }}" required autofocus>
