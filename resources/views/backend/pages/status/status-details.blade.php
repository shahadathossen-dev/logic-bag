...
@php 
    $data['breadcrumb'] =   [
        ...
        'Status Details' => route('admin.status.details', ['id' => $status->id]),
    ];
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <table id="status" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <tr><th class="text-right">{{ 'Title' }}</th><td>{{ $status->name }}</td></tr>
                                    <tr><th class="text-right">{{ 'Created at' }}</th><td>{{ $status->created_at->format('H:i:s d-m-Y') }}</td></tr>
                                    <tr><th class="text-right">{{ 'Updated at' }}</th><td>{{ $status->updated_at ? $status->updated_at->format('H:i:s d-m-Y') : '' }}</td></tr>
                                </tbody>
                            </table>
                        </div>
                    </div>
