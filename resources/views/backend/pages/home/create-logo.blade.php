...
@php 
    $data['breadcrumb'] =   [
            ...
            'Add Logo' => route('admin.page.trade-marks.logo.create'),
        ];
    $data['title'] = 'Add Logo';
@endphp
            ...
            <div class="row justify-content-center">
                <div class="col-md-10">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.page.trade-marks.logo.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-offset-2 col-md-6 text-center">
                                        <img class="" id="selectedImage" width="100" height="120" src="#" alt="Logo image"/>
                                    </div>
                                </div>
                            </form>
                        </div>
