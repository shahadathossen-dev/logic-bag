...
@php 
    $data['breadcrumb'] =   [
            ...
            'Subcategories' => route('admin.categories'),
            'Add Subcategory' => route('admin.category.add'),
        ];
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.subcategory.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label for="title" class="col-md-3 col-form-label text-md-right">{{ __('Subcategory Title') }}</label>
