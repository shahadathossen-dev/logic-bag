                  ...
                  @foreach($users as $user)
                    <tr>
                      ...
                      <form method="POST" action="{{ route('admin.user.update', ['id' => $user['id']]) }}">
                        ...
                        <td class="form-group">
                          <button class="btn btn-info" type="submit" title="Update User" value="Update"><i class="fas fa-user-edit"></i></button>
                          <a class="btn btn-success" href="{{ route('admin.user.details', ['id' => $user['id']]) }}" title="User Details"><i class="fas fa-user-check"></i></a>
                          <a class="btn btn-danger" href="{{ route('admin.user.remove', ['id' => $user['id']]) }}" title="Remove User"><i class="fas fa-user-times"></i></a>
                        </td>
                      </form>
                    </tr>
                  @endforeach
